...
/// A wrapper around the [TextField] widget.
...
class _BasicTextFieldState extends State<BasicTextField> {
  ...
  void _initializeErrorState() => _isErrorState = widget.errorText != null;
  ...
  void _onChanged(String text) => widget.onChanged?.call(text);
        ...
        Focus(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              labelStyle: widget.labelStyle ?? TextStyles.body02,
