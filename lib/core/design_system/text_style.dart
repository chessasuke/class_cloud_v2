...
class TextStyles {
  ...
  static const double caption01FontSize = 16;
  static const double caption01LineHeight = 20;
  ...
  static const double caption02FontSize = 14;
  static TextStyle caption02 = TextStyles.designSystemBaseTextStyle.copyWith(
    fontWeight: FontWeights.medium,
    fontSize: caption02FontSize,
    height: 16 / caption02FontSize,
  );
  ...
  static final linkTextButtonTextStyle =
      TextStyles.designSystemBaseTextStyle.copyWith(
    color: Colors.blue,
    fontWeight: FontWeights.normal,
    fontSize: body02FontSize,
    height: 20 / body02FontSize,
    letterSpacing: TextStyles.body02FontSize * 0.01,
  );
}
